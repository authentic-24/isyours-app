...
class EducationLevelService
{
    ...
    /**
     * Retrieve education levels from API using an HTTP client.
    ...
    public function getEducationLevels()
    {
        ...
        try {
            // Send a GET request to the education levels endpoint.
            $response = $client->get(route('educationlevels.index'));
