            ...
            <div class="row grid-base wow fadeInUp">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="work-block -type-2 mb-0">
                        <div class="inner-box">
                            <figure class="image-box"><a href="#"><img src="<?php echo e(asset('images/index-11/clients/1.svg')); ?>"
                                        alt=""></a></figure>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="work-block -type-2 mb-0">
                        <div class="inner-box">
                            <figure class="image-box"><a href="#"><img src="<?php echo e(asset('images/team/julian.jpg')); ?>"
                                        alt=""></a></figure>
...
<?php echo $__env->make('layouts.app_home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\isyours\resources\views\home\about.blade.php ENDPATH**/ ?>