                    ...
                    <div class="ls-widget">
                        <div class="tabs-box">
                            <div class="widget-content">
                                ...
                                <form class="default-form" action="<?php echo e(route('job.post')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <select name="job_level_id" data-placeholder="Select job level"
                                                ...
                                                <?php $__currentLoopData = $jobLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobLevel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($jobLevel->id); ?>"><?php echo e($jobLevel->name); ?></option>
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <select data-placeholder="Select education level" name="education_level_id"
                                                ...
                                                <?php $__currentLoopData = $educationLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education_level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($education_level->id); ?>">
                                                        <?php echo e($education_level->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <select data-placeholder="Select Proficiency Level"
                                                ...
                                                required>
                                                <option value=""></option>
                                                <?php $__currentLoopData = $proficiencyLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proficiencylevel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($proficiencylevel->id); ?>">
                                                        <?php echo e($proficiencylevel->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 responsibilities-container">
                                            ...
                                            <p>Please enter up to 10 key responsibilities, each with a maximum of 300 characters.</p>

                                            <!-- Responsibility Input -->
                                            <div class="responsibility-input">
                                                <input type="text" class="responsibility-text" maxlength="300">
                                                <button type="button" class="theme-btn btn-style-one add-responsibility-btn">Add</button>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.app_home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\isyours\resources\views\job_offer\create.blade.php ENDPATH**/ ?>