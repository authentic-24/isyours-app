            ...
            <div class="row">
                    ...
                    <div class="footer-widget">
                        <div class="logo" style="margin-bottom: 20px;">
                            <a href="<?php echo e(route('home')); ?>">
                                <img src="<?php echo e(asset('images/logo-main.svg')); ?>" alt="Is Yours" style="max-width: 140px;">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 footer-column">
                    <div class="footer-widget links-widget">
                        <h4 class="widget-title"><?php echo e(__('home.quick_links')); ?></h4>
                        <ul class="list">
                            <li><a href="<?php echo e(route('home')); ?>"><?php echo e(__('home.home')); ?></a></li>
                            <li><a href="<?php echo e(route('about')); ?>"><?php echo e(__('home.about_us')); ?></a></li>
                            <li><a href="#"><?php echo e(__('home.find_jobs_link')); ?></a></li>
                            <li><a href="#"><?php echo e(__('home.post_job')); ?></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 footer-column">
                    <div class="footer-widget links-widget">
                        <h4 class="widget-title"><?php echo e(__('home.for_candidates')); ?></h4>
                        <ul class="list">
                            <li><a href="#"><?php echo e(__('home.browse_jobs')); ?></a></li>
                            <li><a href="#"><?php echo e(__('home.career_advice')); ?></a></li>
                            <li><a href="#"><?php echo e(__('home.faq')); ?></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 footer-column">
                    <div class="footer-widget">
                        <h4 class="widget-title"><?php echo e(__('home.contact_us')); ?></h4>
                        <div class="phone-num">
        ...
        <div class="auto-container">
            <div class="outer-box">
                <div class="copyright-text">
                    &copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(route('home')); ?>">Is Yours</a>. <?php echo e(__('home.all_rights_reserved')); ?>.
                </div>
...
</footer><?php /**PATH C:\laragon\www\isyours\resources\views/layouts/footer.blade.php ENDPATH**/ ?>