                    ...
                    <div class="ls-widget">
                        <div class="tabs-box">
                            <div class="widget-content">
                                ...
                                <form class="default-form" action="<?php echo e(route('create_post')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
...
<?php /**PATH C:\laragon\www\isyours\resources\views\offer\partial_create_job.blade.php ENDPATH**/ ?>