                    ...
                    <div class="footer-widget">
                        <div class="logo" style="margin-bottom: 10px;">
                            <a href="<?php echo e(route('home')); ?>">
                                <img src="<?php echo e(asset('images/logo-main.svg')); ?>" alt="Is Yours" style="max-width: 100px; opacity: 0.8;">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 footer-column mb-3">
                    <div class="footer-widget links-widget">
                        ...
                        <ul class="list">
                            ...
                            <li><a href="<?php echo e(route('web.offer.index')); ?>">Find Jobs</a></li>
                            <li><a href="<?php echo e(route('web.offer.create')); ?>">Post Jobs</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="dashboard-container">
            <div class="outer-box">
                <div class="copyright-text">
                    &copy; 2025 <a href="<?php echo e(route('home')); ?>">Is Yours</a>. All rights reserved.
                </div>
...
</footer><?php /**PATH C:\laragon\www\isyours\resources\views/layouts/footerapp.blade.php ENDPATH**/ ?>