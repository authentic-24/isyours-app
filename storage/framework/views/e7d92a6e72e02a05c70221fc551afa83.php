                        ...
                        <form method="POST" action="<?php echo e(route('register_post')); ?>" class="enhanced-form">
                            ...
                            <div class="form-options">
                                <div class="terms-agreement">
                                    ...
                                    <select id="security_id" name="security_id" class="form-control-enhanced" style="width: 100%; margin-bottom: 10px;">
                                        <option value="no" <?php echo e(old('security_id') == 'no' ? 'selected' : ''); ?>>No</option>
                                        <option value="yes" <?php echo e(old('security_id') == 'yes' ? 'selected' : ''); ?>>Sí</option>
                                        <option value="in_process" <?php echo e(old('security_id') == 'in_process' ? 'selected' : ''); ?>>En trámite</option>
                                    </select>
                                    <div id="security_digits_field" style="display: <?php echo e(old('security_id') == 'yes' ? 'block' : 'none'); ?>; margin-top: 10px;">
                                        <input type="text" id="security_id_last_digits" name="security_id_last_digits" 
                                               ...
                                               maxlength="4" pattern="\d{4}" value="<?php echo e(old('security_id_last_digits')); ?>">
                                    </div>
                                </div>
                            </div>
                            <script>
                            ...
                            <div class="form-options">
                                <div class="terms-agreement">
                                    ...
                                    <label for="agree_terms" class="form-check-label"><?php echo e(__('home.i_agree_to')); ?> <a href="<?php echo e(route('terms')); ?>" target="_blank" style="color: #1a1a1a; font-weight: 600;"><?php echo e(__('home.terms_conditions')); ?></a> <?php echo e(__('home.and')); ?> <a href="<?php echo e(route('privacy')); ?>" target="_blank" style="color: #1a1a1a; font-weight: 600;"><?php echo e(__('home.privacy_policy')); ?></a></label>
                                </div>
                            </div>
