...
<head>
    ...
    <title><?php echo e(__("home.register_create_account")); ?> &mdash; Is Yours</title>
...
<main>
    <div class="rg-center">
        ...
        <div class="rg-brand">
            <img src="<?php echo e(asset('images/logo-main.svg')); ?>" alt="Is Yours" class="rg-brand-logo">
            <p><?php echo e(__("home.register_subtitle")); ?></p>
        </div>

        <div class="rg-card">
            <h1 class="rg-card-title"><?php echo e(__("home.register_create_account")); ?></h1>
            <p class="rg-card-sub"><?php echo e(__("home.register_subtitle")); ?></p>
            ...
            <form method="POST" action="<?php echo e(route('register_post')); ?>" novalidate>
                <?php echo csrf_field(); ?>

                
                <input type="hidden" id="user_type" name="user_type" value="<?php echo e(old('user_type', 'candidate')); ?>">
                <div class="role-toggle">
                    <div class="role-btn <?php echo e(old('user_type','candidate') === 'candidate' ? 'active' : ''); ?>" data-role="candidate" tabindex="0" role="button" aria-pressed="<?php echo e(old('user_type','candidate') === 'candidate' ? 'true' : 'false'); ?>">
                        <span class="material-symbols-outlined role-icon">person_search</span>
                        <span class="role-label"><?php echo e(__("home.candidate")); ?></span>
                        <span class="role-desc"><?php echo e(__("home.im_looking_for_work") ?? "Looking for a job"); ?></span>
                    </div>
                    <div class="role-btn <?php echo e(old('user_type','candidate') === 'employer' ? 'active' : ''); ?>" data-role="employer" tabindex="0" role="button" aria-pressed="<?php echo e(old('user_type','candidate') === 'employer' ? 'true' : 'false'); ?>">
                        <span class="material-symbols-outlined role-icon">business_center</span>
                        <span class="role-label"><?php echo e(__("home.employer")); ?></span>
                        <span class="role-desc"><?php echo e(__("home.im_hiring") ?? "Hiring talent"); ?></span>
                    </div>
                </div>

                <div class="rg-section">
                    <p class="rg-section-title"><?php echo e(__("home.personal_information")); ?></p>
                    <div class="rg-grid rg-grid-2">
                        <div>
                            <label class="rg-label" for="first_name"><?php echo e(__("home.first_name")); ?></label>
                            <input id="first_name" name="first_name" class="rg-input" value="<?php echo e(old("first_name")); ?>" required>
                        </div>
                        <div>
                            <label class="rg-label" for="last_name"><?php echo e(__("home.last_name")); ?></label>
                            <input id="last_name" name="last_name" class="rg-input" value="<?php echo e(old("last_name")); ?>" required>
                        </div>
                    </div>
                </div>

                <div class="rg-section">
                    <p class="rg-section-title"><?php echo e(__("home.country")); ?> &amp; <?php echo e(__("home.phone_number")); ?></p>
                    <div class="rg-grid rg-grid-3">
                        <div>
                            <label class="rg-label" for="country"><?php echo e(__("home.country")); ?></label>
                        ...
                        <div>
                            <label class="rg-label" for="state"><?php echo e(__("home.state")); ?></label>
                            <select id="state" name="state_id" class="rg-select" required>
                                <option value=""><?php echo e(__("home.select_state")); ?></option>
                            </select>
                        </div>
                        <div>
                            <label class="rg-label" for="city"><?php echo e(__("home.city")); ?></label>
                            <select id="city" name="city_id" class="rg-select" required>
                                <option value=""><?php echo e(__("home.select_city")); ?></option>
                            </select>
                        </div>
                        <div>
                            <label class="rg-label" for="zip_code"><?php echo e(__("home.zip_code")); ?></label>
                            <input id="zip_code" name="zip_code" class="rg-input" pattern="\d{5}" maxlength="5" value="<?php echo e(old("zip_code")); ?>" required>
                        </div>
                        <div>
                            <label class="rg-label" for="phone_number"><?php echo e(__("home.phone_number")); ?></label>
                            <input id="phone_number" name="phone_number" class="rg-input" value="<?php echo e(old("phone_number")); ?>" required>
                        </div>
                        <div>
                            <label class="rg-label" for="email"><?php echo e(__("home.email_address")); ?></label>
                            <input id="email" type="email" name="email" class="rg-input" value="<?php echo e(old("email")); ?>" required>
                        </div>
                    </div>
                </div>

                <div class="rg-section">
                    <p class="rg-section-title"><?php echo e(__("home.password")); ?></p>
                    <div class="rg-grid rg-grid-2">
                        <div>
                            <label class="rg-label" for="password-field"><?php echo e(__("home.password")); ?></label>
                        ...
                        <div>
                            <label class="rg-label" for="confirmPassword"><?php echo e(__("home.confirm_password") ?? "Confirm Password"); ?></label>
                    ...
                    <div style="margin-top:16px;display:flex;flex-direction:column;gap:12px;">
                        <div class="rg-checkbox-row">
                            ...
                            <input type="checkbox" id="have_vehicle" name="have_vehicle" value="1" <?php echo e(old("have_vehicle") ? "checked" : ""); ?>>
                            <label for="have_vehicle"><?php echo e(__("home.have_vehicle") ?? "Do you have a vehicle?"); ?></label>
                        </div>

                        <div>
                            <label class="rg-label" for="security_id"><?php echo e(__("home.has_security_id")); ?></label>
                            <select id="security_id" name="security_id" class="rg-select">
                                <option value="no" <?php echo e(old("security_id") == "no" ? "selected" : ""); ?>><?php echo e(__("home.security_id_no")); ?></option>
                                <option value="yes" <?php echo e(old("security_id") == "yes" ? "selected" : ""); ?>><?php echo e(__("home.security_id_yes")); ?></option>
                                <option value="in_process" <?php echo e(old("security_id") == "in_process" ? "selected" : ""); ?>><?php echo e(__("home.security_id_in_process")); ?></option>
                            </select>
                        </div>

                        <div id="security_digits_field" style="display:<?php echo e(old('security_id') == 'yes' ? 'block' : 'none'); ?>;">
                            <label class="rg-label" for="security_id_last_digits"><?php echo e(__("home.security_id_last_4_digits")); ?></label>
                            <input type="text" id="security_id_last_digits" name="security_id_last_digits" class="rg-input" maxlength="4" pattern="\d{4}" value="<?php echo e(old("security_id_last_digits")); ?>">
                        </div>

                        <div class="rg-checkbox-row">
                            <input type="checkbox" id="agree_terms" name="is_agree_terms_privacy" value="1" required <?php echo e(old("is_agree_terms_privacy") ? "checked" : ""); ?>>
                            <label for="agree_terms">
                                <?php echo e(__("home.i_agree_to")); ?>
                ...
                <button type="submit" class="rg-submit"><?php echo e(__("home.create_account")); ?></button>
            </form>

            <p class="rg-footer">
                <?php echo e(__("home.already_have_account")); ?>

                <a href="<?php echo e(route('web_login')); ?>"><?php echo e(__("home.sign_in")); ?></a>
            </p>
        </div>
...
$(function () {
    ...
    $("#country").on("change", function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                fillSelect("state", "id", "name", res.states, "<?php echo e(__('home.state')); ?>");
                $("#city").empty().append($("<option>").val("").text("<?php echo e(__('home.select_city')); ?>"));
            }
        });
    });
    $("#state").on("change", function () {
        ...
        $.ajax({
            ...
            method: "GET",
            success: function (res) {
                fillSelect("city", "id", "name", res.cities, "<?php echo e(__('home.city')); ?>");
            }
        });
    });
...
<?php /**PATH C:\laragon\www\isyours\resources\views/register/index.blade.php ENDPATH**/ ?>