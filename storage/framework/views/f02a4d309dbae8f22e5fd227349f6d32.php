                                ...
                                <div class="job-block col-lg-6 col-md-12 col-sm-12">
                                    <div class="inner-box">
                                        <div class="content">
                                            ...
                                            <h4 class="job-title"><a href="<?php echo e(route('web.offer.show', ['id' => $offer->id])); ?>"><?php echo e(trans_job_level($offer->job_level_name ?? '')); ?> / <?php echo e(trans_job_title($offer->job_title_name ?? '')); ?></a></h4>
                                            <ul class="job-info">
                                            ...
                                            <ul class="job-other-info">
                                                <li class="time"><?php echo e(trans_job_type($offer->job_type->name ?? 'Full Time')); ?></li>
                                                <li class="privacy"><?php echo e(trans_job_level($offer->job_level->name ?? 'Private')); ?></li>
                    ...
                    <div class="feature-block">
                        <div class="inner-box">
                            ...
                            <div class="overlay-box">
                                <div class="content">
                                    <h5>Miami</h5>
                                    <span class="total-jobs">0 <?php echo e(__('home.jobs_count')); ?></span>
